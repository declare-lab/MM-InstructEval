...
from predict_LaVIN import get_label_space
import argparse
...
def main():
    ...
    if args.selected_tasks:
        ...
        selected_tasks = ["sc", "mast", "absa", "MSC", "MASC", "MNRE", "MHM", "Multimodal_Sarcasm_Detection", "Multimodal_Rumor"]
    ...
    for task in selected_tasks:
        ...
        if setting in ["zero-shot", "full", "majority", "random"]:
            ...
            if args.slm_model_name:
                ...
                task_output_folder = f"outputs/{setting}_{args.prompt_type}/shot_{shots}/model_{args.model_name}/seed_{args.seed}/{task}/"
        metric_dict = {}
        ...
        for dataset in selected_datasets:
            with open(os.path.join(task_output_folder, dataset, "metric.txt"), 'w') as f:
