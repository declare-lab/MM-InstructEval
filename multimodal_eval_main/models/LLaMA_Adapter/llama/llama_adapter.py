...
from multimodal_eval_main.models.LLaMA_Adapter.CLIP import clip
import torch
...
class LLaMA_adapter(nn.Module):
    ...
    def __init__(self, llama_ckpt_dir, llama_tokenizer,
        ...
        self.clip, self.clip_transform = clip.load(clip_model,device = torch.device('cuda'))
    ...
    def generate(
        ...
        for k, t in enumerate(prompts):
            # print(len(tokens[k]),t)
            tokens[k, : len(t)] = torch.tensor(t).cuda().long()[:512]
