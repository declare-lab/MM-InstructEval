...
def create_eva_vit_g(img_size=224, drop_path_rate=0.4, load_params=True, use_checkpoint=False, vision_feats_return_layer=-1):
    ...
    if load_params:
        ...
        assert os.path.exists("/data/xiaocui/weights/lynx_llm/EVA01_g_psz14.pt")
        state_dict = torch.load("/data/xiaocui/weights/lynx_llm/EVA01_g_psz14.pt", map_location="cpu")
