...
from multimodal_eval_main.models.VPGTrans.lavis.common.utils import get_cache_path
from multimodal_eval_main.models.VPGTrans.lavis.datasets.builders.base_dataset_builder import BaseDatasetBuilder
from multimodal_eval_main.models.VPGTrans.lavis.datasets.datasets.video_vqa_datasets import VideoQADataset
