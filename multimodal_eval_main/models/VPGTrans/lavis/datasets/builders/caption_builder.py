...
from multimodal_eval_main.models.VPGTrans.lavis.datasets.datasets.coco_caption_datasets import (
    COCOCapDataset,
    COCOCapEvalDataset,
    NoCapsEvalDataset,
)
...
from multimodal_eval_main.models.VPGTrans.lavis.datasets.datasets.video_caption_datasets import (
    VideoCaptionDataset,
